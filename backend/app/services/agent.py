...
def _system_prompt(currency: str) -> str:
    return (
        ...
        "Si un gasto o ingreso no encaja claramente en ninguna categoría existente, usa la categoría 'Otro' en "
        "vez de forzarlo en una que no corresponde, o crea una categoría nueva con create_category si es algo "
        "que claramente se va a repetir (ej. una suscripción). "
